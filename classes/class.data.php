...
class Data {
    ...
    public $patters = array("data_barra" => "/(^(((0[1-9]|[12][0-8])[\\/](0[1-9]|1[012]))|((29|30|31)[\\/](0[13578]|1[02]))|((29|30)[\\/](0[4,6,9]|11)))[\\/](19|[2-9][0-9])\\d\\d$)|(^29[\\/]02[\\/](19|[2-9][0-9])(00|04|08|12|16|20|24|28|32|36|40|44|48|52|56|60|64|68|72|76|80|84|88|92|96)$)/mi", "data_hifen" => "/(^(((0[1-9]|[12][0-8])[-](0[1-9]|1[012]))|((29|30|31)[-](0[13578]|1[02]))|((29|30)[-](0[4,6,9]|11)))[-](19|[2-9][0-9])\\d\\d$)|(^29[-]02[-](19|[2-9][0-9])(00|04|08|12|16|20|24|28|32|36|40|44|48|52|56|60|64|68|72|76|80|84|88|92|96)$)/mi");
    public $data = array();
     ...
     * @return type boolean
     */
    public function check_Date_NP($dia, $mes, $ano) {
...
//echo date('d/m/Y', strtotime($data . " + $quantidade_dias days"));
     ...
     * @param type $d2
     */
    public function subtrair_data($d1, $d2) {
        try {
            ...
            return array('dia' => $intervalo->d, 'hor' => $intervalo->h,'min'=>$intervalo->i);
        } catch (Exception $exc) {
            echo $exc->getMessage();
        }
    }
     ...
     * @return type
     */
    public function get_Mktime($mes, $dia, $ano, $data = "") {
        return mktime(date("Y"), date("i"), date("s"), (int) $mes, (int) $dia, (int) $ano);
    }
     ...
     * @return type
     */
    public function get_mktime_from_data($data = "", $s = true, $matches = "") {
        if ($data === "") {
            return time();
        } else {
            if (preg_match($this->patters["data_barra"], $data, $matches) == true) {
                $d = explode("/", $matches[0]);
                if ($s == true) {
                    return mktime(0, 0, 0, $d[1], $d[0], $d[2]);
                } else {
                    return mktime(date("H"), date("i"), date("s"), $d[1], $d[0], $d[2]);
                }
            }

            if (preg_match($this->patters["data_hifen"], $data, $matches) == true) {
                $d = explode("-", $matches[0]);
                if ($s == true) {
                    return mktime(0, 0, 0, $d[1], $d[0], $d[2]);
                } else {
     ...
     * @param type $day
     * @param type $year
     * @return Data Um timespam
     */
    public function get_data_from_data_e_hora($hour, $minute, $second, $month, $day, $year) {
     ...
     * @param type $data
     * @param type $matches
     * @return string 0 Primeiro index é o dia, o segundo é o mês e o terceiro é o ano.
     */
    public function get_data_format($data, $matches = "") {
        $d = null;
        if (preg_match($this->patters["data_barra"], $data, $matches) == true) {
            $d = explode("/", $matches[0]);
        }
     ...
     */
    public function get_Data_From_get_Mktime($timestamp, $barra = false) {
        if ($barra == false) {
     ...
     * @return type
     */
    public function get_Data($format = '', $timestamp = '') {
