    ...
    <head>
        ...
        <div class="container">
            <div class="hero-unit">
                ...
                <div class="subheader"> 
                <hr/>
                <a href="#modal_tabela3" role="button" class="btn btn-success" data-toggle="modal">Adicionar Novo</a>
                    <hr/>
        <!-- Modal -->
<div id="modal_tabela3" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h3 id="myModalLabel">Add Novo</h3>
  </div>
  <div class="modal-body"><form action="modelos/model.tabela3.php" id="form_tabela3" method="POST">
...
<input type="hidden" name="acao" value="inserir" /></div></form><br/></div>
  <div class="modal-footer">
    ...
    <button class="btn btn-primary" form="form_tabela3">Salvar mudanças</button>
  </div>
...
<th>TAB_4:</th><th>TAB_5:</th><th>#</th></tr>
                        ...
                        $f = $tabela3->getDados(); while ($row = $f->fetch(PDO::FETCH_OBJ)) {
                            ?>
...
window.location.reload();
            ...
            $('#linha_'+_id).remove();
            $.post('modelos/model.tabela3.php',{acao:'excluir',id:_id},function(_result){
            if(_result=='1'){
