    ...
    <head>
        ...
        <div class="container">
            <div class="hero-unit">
                ...
                <div class="subheader"> 
                <hr/>
                <a href="#modal_Setor" role="button" class="btn btn-success" data-toggle="modal">Adicionar Novo</a>
                    <hr/>
        <!-- Modal -->
<div id="modal_Setor" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h3 id="myModalLabel">Add Novo</h3>
  </div>
  <div class="modal-body"><form action="modelos/model.setor.php" id="form_Setor" method="POST">
...
<input type="hidden" name="acao" value="inserir" /></div></form><br/></div>
  <div class="modal-footer">
    ...
    <button class="btn btn-primary" form="form_Setor">Salvar mudanças</button>
  </div>
...
<th>NOME:</th><th>#</th></tr>
                        ...
                        $f = $Setor->getDados(); while ($row = $f->fetch(PDO::FETCH_OBJ)) {
                            ?>
                            <tr id="linha_<?php echo $row->set_id?>"><td><?php echo $row->set_id?></td>
<td><?php echo $row->set_nome?></td><td style="text-align: right;"><button class="btn btn-editar btn-success">
...
window.location.reload();
            ...
            $('#linha_'+_id).remove();
            $.post('modelos/model.Setor.php',{acao:'excluir',id:_id},function(_result){
            if(_result=='1'){
