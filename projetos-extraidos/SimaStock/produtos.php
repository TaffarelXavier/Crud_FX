...
<div class="row-fluid"> <label><b>DESCRICAO:</b></label>
 <input name="descricao" autofocus="" required="" type="text" class="span12" />
...
<th>CODIGO_BARRAS:</th><th>HABILITAR_NOTA_FISCAL:</th><th>#</th></tr>
                        <?php
                        $Produtos = new Produtos($connection);

                        $f = $Produtos->getDados(); while ($row = $f->fetch(PDO::FETCH_OBJ)) {
                            ?>
...
<td><?php echo $row->pro_codigo_barras?></td><td><?php echo $row->pro_habilitar_nota_fiscal?></td><td style="text-align: right;"><button class="btn btn-editar btn-success">
